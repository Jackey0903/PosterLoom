...
The public page currently uses anonymous author metadata. Replace the author, affiliation, venue, and BibTeX fields in `index.html` after the anonymous review period.

## License

Website structure follows the upstream template's CC BY-SA 4.0 license. Paper figures and project assets remain subject to their respective project license.
